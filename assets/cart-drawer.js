class CartDrawer {
      ...
      <div class="cart-drawer-footer">
        ...
        <div class="cart-drawer-subtotal">
          ...
          <div class="cart-drawer-subtotal-price">
            ...
            <span class="bold" data-cart-subtotal>${this.formatMoney(this.cartData.total_price)}</span>
            ${
              this.getTotalSavings() > 0
        ...
        <div class="cart-drawer-actions">
          <div class="cart-drawer-payment-terms"></div>
  ...
  initializeShopPayInstallments() {
    const target = this.drawer.querySelector(".cart-drawer-payment-terms");
    if (!target) {
      return;
    }

    const source = document.querySelector("#cart-payment-terms .shopify-payment-terms");
    if (!source) {
      return;
    }
