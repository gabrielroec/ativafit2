(function (factory) {
    ...
    _createClass(CollectionFilterDrawer, [
      ...
      },
      {
        ...
        value: function _computeDrawerHeight() {
          document.getElementById("mobile-collection-filters").querySelector(".collection-drawer").style.maxHeight = "".concat(
            window.innerHeight,
            "px"
          );
        },
      ...
      },
      {
        ...
        value: function _colorChanged(event, target) {
          ...
          if (
            ...
            target.getAttribute("data-media-id") !== originalImageElement.getAttribute("data-media-id")
          ) {
    ...
    _createClass(StoreAvailability, [
      ...
      },
      {
        ...
        value: function _renderAvailabilitySection(id) {
          ...
          return fetch("".concat(window.routes.rootUrlWithoutSlash, "/variants/").concat(id, "?section_id=store-availability")).then(
            function (response) {
        ...
        value: function _updateProductPrices(newVariant, previousVariant) {
          ...
          if (!newVariant) {
            ...
            if (newVariant["compare_at_price"] > newVariant["price"]) {
              productPrices.innerHTML += '<span class="price price--highlight"><span class="visually-hidden">'
                .concat(window.languages.productSalePrice, "</span>")
                .concat(Currency.formatMoney(newVariant["price"], currencyFormat), "</span>");
              productPrices.innerHTML += '<span class="price price--compare"><span class="visually-hidden">'
                ...
                .concat(Currency.formatMoney(newVariant["compare_at_price"], currencyFormat), "</span>");
            } else {
        ...
        value: function _updateInventory(newVariant) {
          ...
          if (stockCountdown) {
            var stockCountdownProgress = Math.min(
              Math.max((variantInventoryQuantity / parseInt(stockCountdown.getAttribute("data-stock-countdown-max"))) * 100.0, 0),
              100
            );
        ...
        value: function _updateDiscountLabel(newVariant, previousVariant) {
          ...
          if (!newVariant || !(newVariant["price"] < newVariant["compare_at_price"])) {
            ...
            if (window.theme.discountMode === "percentage") {
              savings = "".concat(
                Math.round(((newVariant["compare_at_price"] - newVariant["price"]) * 100) / newVariant["compare_at_price"]),
                "%"
              );
            } else {
              savings = "<span>".concat(
                Currency.formatMoney(newVariant["compare_at_price"] - newVariant["price"], window.theme.moneyFormat),
                "</span>"
              );
            }
      ...
      },
      {
        ...
        value: function _updateUnitPrice(newVariant, previousVariant) {
          ...
          if (!newVariant || !newVariant["unit_price_measurement"]) {
            ...
            unitPriceMeasurement.querySelector(".unit-price-measurement__price").innerHTML = Currency.formatMoney(
              newVariant["unit_price"],
              window.theme.moneyFormat
            );
            unitPriceMeasurement.querySelector(".unit-price-measurement__reference-unit").innerHTML =
        ...
        /**
         * Ativafit automatically adds a "disabled" state to sold out/unavailable variant. When we change the variant we have to recompute
         * all the selectors
         */
      },
      {
          ...
          if (!newVariant) {
            ...
            if (newVariant["available"]) {
              ...
              addToCartButtonElement.innerHTML =
                this.productTemplate === "pre-order" ? window.languages.productFormPreOrder : window.languages.productFormAddToCart;
            } else {
              addToCartButtonElement.setAttribute("disabled", "disabled");
              addToCartButtonElement.classList.add("button--disabled");
              addToCartButtonElement.classList.remove("button--primary");
      ...
      var PhotoSwipe = function PhotoSwipe(template, UiClass, items, options) {
        ...
        var _getItemAt,
          ...
          _calculateSingleItemPanBounds = function _calculateSingleItemPanBounds(item, realPanElementW, realPanElementH) {
            ...
            bounds.max.y =
              realPanElementH > _tempPanAreaSize.y ? Math.round(_tempPanAreaSize.y - realPanElementH) + item.vGap.top : bounds.center.y; // minimum pan position
  ...
  function isDOMElement(obj) {
    return HAS_DOM_2
      ...
      : obj && _typeof$1(obj) === "object" && obj !== null && obj.nodeType === 1 && typeof obj.nodeName === "string";
  }
              ...
              if (cell.hasAttribute("data-group-name")) {
                ...
                _this2.options["productOptions"].forEach(function (option, optionIndex) {
                  if (option.toLowerCase() === groupName) {
                    ...
                    if (
                      newVariant["option".concat(optionIndex + 1)].toLowerCase() === cell.getAttribute("data-group-value") ||
                      (newVariant["featured_media"] && newVariant["featured_media"]["id"] === parseInt(cell.getAttribute("data-media-id")))
                    ) {
      ...
      },
      {
        ...
        value: function _onGallerySlideChanged() {
          ...
          if (Responsive.matchesBreakpoint("pocket")) {
            var scrollX =
              newNavElement.offsetLeft - (this.productThumbnailsListElement.parentNode.clientWidth - newNavElement.clientWidth) / 2;
          ...
          if (isOk) {
            ...
            if (shippingRates.length === 0) {
              ...
              shippingRates.forEach(function (item) {
                listRatesHtml += "<li>"
                  .concat(item["name"], ": ")
                  .concat(Currency.formatMoney(parseInt(item["price"] * 100), window.theme.moneyFormat), "</li>");
              });
    ...
    _createClass(ValuePicker, [
      ...
      },
      {
        ...
        value: function _open() {
          document
            .querySelector('[data-action="open-value-picker"][aria-controls="'.concat(this.id, '"]'))
          ...
          try {
            ...
            return fetch(sectionUrl, {
              ...
              response.text().then(function (content) {
                ...
                _this4.element.querySelector(".collection__dynamic-part").innerHTML =
                ...
                if (desktopFilters) {
                  Array.from(_this4.element.querySelectorAll(".collection__filter-group-name[aria-controls]")).forEach(function (
                    groupName
                  ) {
                ...
                var elementOffset =
                  _this4.element.querySelector(".collection").getBoundingClientRect().top -
                  25 -
        ...
        value: function _loadContentResults() {
          ...
          fetch(
            ""
              ...
              .concat(currentUrl.searchParams.get("q"), "&type=article,page"),
            {
              credentials: "same-origin",
            }
          ).then(function (response) {
      ...
      },
      {
        ...
        value: function _fixSafari() {
          ...
          if (
            ...
            (userAgent.includes("version/10.1") || userAgent.includes("version/10.3") || userAgent.includes("version/11.0"))
          ) {
            var isPhone = Responsive.matchesBreakpoint("phone");
            this.element
              .querySelectorAll(".product-item__image-wrapper .aspect-ratio, .product-item__image-wrapper .placeholder-svg")
      ...
      },
      {
        ...
        value: function _setupCookieBar() {
          ...
          try {
            ...
            // Adblockers may prevent the customerPrivacy API from being loaded, so we catch errors here.
          }
        },
      },
      {
  ...
  var SearchBar = /*#__PURE__*/ (function () {
    ...
    _createClass(SearchBar, [
      ...
      },
      {
        ...
        value: function _onFocusOut(event) {
          ...
          if (
            ...
            event.target.closest(".search-bar__inner")
          ) {
            return;
          }
        ...
        value: function _doSearch() {
          ...
          if (currentInput === "") {
            ...
            var queryOptions = {
              ...
              productQuery = ""
                .concat(this.productTypeFilter !== "" ? "product_type:".concat(this.productTypeFilter, " AND ") : "")
                .concat(encodeURIComponent(this.lastInputValue)),
              queries = [
                fetch(
                  ""
                    .concat(url, "?section_id=predictive-search&q=")
                    .concat(productQuery, "&resources[limit]=3&resources[limit_scope]=each"),
                  queryOptions
                ),
              ];
      ...
      },
      {
        ...
        /**
         * Ativafit allows to display a filter by type. When its value change, we re-do a new search to get the new data
         */
      },
      {
        key: "_productTypeChanged",
        value: function _productTypeChanged(event, target) {
          target.closest(".search-bar__filter").querySelector(".search-bar__filter-active").innerText =
        ...
        value: function _fetchProducts() {
          ...
          fetch(
            ...
            response.text().then(function (content) {
              ...
              _this.element.querySelector(".recently-viewed-products-placeholder").innerHTML = tempElement.querySelector(
        ...
        w.scrollBy = function () {
          ...
          if (shouldBailOut(arguments[0])) {
            original.scrollBy.call(
              w,
              arguments[0].left !== undefined ? arguments[0].left : _typeof(arguments[0]) !== "object" ? arguments[0] : 0,
        ...
        value: function connectedCallback() {
          ...
          this.textInputLowerBound.addEventListener("change", function (event) {
            event.target.value = Math.max(
              Math.min(parseInt(event.target.value), parseInt(_this.textInputHigherBound.value || event.target.max) - 1),
              event.target.min
            );
            ...
            _this.rangeLowerBound.parentElement.style.setProperty(
              "--range-min",
              "".concat((parseInt(_this.rangeLowerBound.value) / parseInt(_this.rangeLowerBound.max)) * 100, "%")
            );
          });
          this.textInputHigherBound.addEventListener("change", function (event) {
            event.target.value = Math.min(
              Math.max(parseInt(event.target.value), parseInt(_this.textInputLowerBound.value || event.target.min) + 1),
              event.target.max
            );
            ...
            _this.rangeHigherBound.parentElement.style.setProperty(
              "--range-max",
              "".concat((parseInt(_this.rangeHigherBound.value) / parseInt(_this.rangeHigherBound.max)) * 100, "%")
            );
          });
          ...
          this.rangeLowerBound.addEventListener("input", function (event) {
            ...
            event.target.parentElement.style.setProperty(
              "--range-min",
              "".concat((parseInt(event.target.value) / parseInt(event.target.max)) * 100, "%")
            );
            _this.textInputLowerBound.value = event.target.value;
          });
      ...
      },
      {
        ...
        value: function _loadRecommendations() {
          ...
          var section = this.closest(".shopify-section"),
            ...
            url = ""
              .concat(Shopify.routes.root, "recommendations/products?product_id=")
          ...
          fetch(url).then(function (response) {
            response.text().then(function (text) {
              ...
              if (productRecommendationsElement.childElementCount > 0) {
                _this2.replaceChildren.apply(
                  _this2,
                  _toConsumableArray(document.importNode(productRecommendationsElement, true).childNodes)
                ); // Create Flickity slider
